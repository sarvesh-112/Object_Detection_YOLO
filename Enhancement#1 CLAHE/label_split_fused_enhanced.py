...
if __name__ == "__main__":
    enhanced_img_dir = "C:/Users/smpga/PycharmProjects/Object_detection/datasets/FUSED_Gradient_Enhanced"
    ...
    output_split_dir = "C:/Users/smpga/PycharmProjects/Object_detection/datasets_split/fused_gradient_enhanced"

    print(" Propagating visible labels to enhanced fused label directory...")
    propagate_labels(enhanced_img_dir, visible_label_dir, enhanced_label_dir)

    print("️ Splitting enhanced dataset into train/val...")
    split_dataset(enhanced_img_dir, enhanced_label_dir, output_split_dir)

    print(" YOLO label propagation + dataset split complete for enhanced fused images.")
