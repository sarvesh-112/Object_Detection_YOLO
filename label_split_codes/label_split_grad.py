...
def propagate_labels(img_dir, src_label_dir, dst_label_dir):
    ...
    if missing:
        print(f"️ {len(missing)} label files were missing. Sample:")
        print("\n".join(missing[:5]))
...
if __name__ == "__main__":
    fused_img_dir = "C:/Users/smpga/PycharmProjects/Object_detection/datasets/FUSED_Gradient"
    visible_label_dir = "C:/Users/smpga/PycharmProjects/Object_detection/labels/visible"
    fused_label_dir = "C:/Users/smpga/PycharmProjects/Object_detection/labels/fused"
    output_split_dir = "C:/Users/smpga/PycharmProjects/Object_detection/datasets_split/fused_gradient"

    print(" Propagating visible labels to fused label directory...")
    propagate_labels(fused_img_dir, visible_label_dir, fused_label_dir)

    print("️ Splitting dataset into train/val...")
    split_dataset(fused_img_dir, fused_label_dir, output_split_dir, split_ratio=0.8)

    print(" YOLO label propagation + dataset split complete.")
