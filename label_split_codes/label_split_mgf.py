...
if __name__ == "__main__":
    ...
    img_dir = os.path.join(base, "datasets/FUSED_MGF")
    visible_labels = os.path.join(base, "labels/visible")
    fused_label_dir = os.path.join(base, "labels/fused")
    split_out = os.path.join(base, "datasets_split/fused_mgf")

    print(" Propagating labels for FUSED_MGF...")
    propagate_labels(img_dir, visible_labels, fused_label_dir)

    print("️ Splitting dataset for FUSED_MGF...")
